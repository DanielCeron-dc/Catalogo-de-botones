  ...
  return (
    <div style={{ display: "flex" }}>
      ...
      <Card texto={"contained Button"}>
        <Animation show = {ejecutarAnimacion} Animation = {`${Animaciones.prueba} 0.5s 5`} onAnimationEnd = {() => setEjecutarAnimacion(false)} NotdestroyChildren>
          <Button style={buttonStyles[0]} onHover={hoverStyles[0]} onClick = {() => setEjecutarAnimacion(true)}>
               ejecutar
          </Button>
        </Animation>
      </Card>
